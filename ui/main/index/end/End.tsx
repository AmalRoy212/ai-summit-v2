        ...
        <div className="relative z-10  py-20 px-6 lg:px-10 rounded-2xl shadow-2xl">
          <div className="text-center lg:text-left">
            ...
            <div className="w-full flex justify-center">
              <button onClick={() => router.push('/delegates')} className="cursor-pointer  w-auto px-10 py-2 shadow-md shadow-[#7042f861]/50 border rounded-3xl border-[#7042f861] bg-gradient-to-r from-purple-500 to-cyan-500 mt-4 text-[10px] hover:from-cyan-500 hover:to-purple-500">
                Register now
              </button>
            </div>
          </div>
