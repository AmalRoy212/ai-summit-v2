  ...
  return (
    ...
    >
      <div className="flex justify-center items-center p-0 m-0 h-full w-full relative">
        {/* <h1 className={`absolute md:left-13 left-[5rem] md:mt-[-9rem] mt-[-9rem] text-xl md:m-[-1rem] font-bold text-slate-200`}>
          {data.number === '25%' && <span className="text-[26px]">CAGR </span>}{data.number}
        </h1> */}
        <h1 className="font-bold text-6xl text-slate-200 absolute md:top-14 top-5">
          {data.number}
        </h1>
